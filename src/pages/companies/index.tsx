...
function CompanyListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<CompanyInterface[]>(
    ...
    () =>
      getCompanies({
        relations: ['user', 'dashboard.count', 'invitation.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('dashboard', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>dashboard</Th>}
