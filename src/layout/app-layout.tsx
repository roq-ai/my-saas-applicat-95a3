...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiBriefcase, FiLayout } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['data-analyst'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Dashboard', path: '/dashboards', entity: 'dashboard', service: AccessServiceEnum.PROJECT, icon: FiLayout },
    {
      name: 'Invitation',
      path: '/invitations',
      entity: 'invitation',
